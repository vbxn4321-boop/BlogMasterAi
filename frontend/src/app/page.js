        ...
        <div style={{ maxWidth:1100,margin:"0 auto" }}>
          ...
          <div style={{ display:"grid",gridTemplateColumns:"repeat(auto-fit, minmax(300px, 1fr))",gap:24,alignItems:"start" }}>
            ...
            <div className="pricing-card" style={{ padding:"40px 32px",borderRadius:24,background:"var(--bg-card)",border:"1px solid var(--border)",transition:"transform 0.3s ease, box-shadow 0.3s ease" }}>
              ...
              <Link href="/login?redirect=%2Fdashboard%2Fsettings%3Fplan%3Dbasic" className="pricing-btn-outline" style={{ display:"block",textAlign:"center",textDecoration:"none",padding:"14px 0",borderRadius:12,border:"2px solid var(--accent)",color:"var(--accent)",fontWeight:800,fontSize:15,marginBottom:32,transition:"all 0.2s ease" }}>시작하기</Link>
